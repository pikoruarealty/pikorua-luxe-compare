    ...
    <div className="max-w-xl">
      ...
      <div className="mt-6 flex gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-full bg-champagne px-5 py-2.5 text-xs font-medium tracking-[0.14em] text-lux-black uppercase transition-opacity hover:opacity-90 disabled:opacity-60"
        >
