...
const PARTNERS: Partner[] = [
  ...
  { name: "The Capstone Developers", logo: "/partners/capstone.png", width: 300, height: 107, projectName: "Capstone" },
  { name: "Constera Realty", logo: "/partners/constera.png", width: 222, height: 50 },
  { name: "Gala Group", logo: "/partners/gala.png", width: 100, height: 133, overrideClass: "h-11 sm:h-12 max-w-[155px] scale-110" },
  ...
  { name: "Maruti Group", logo: "/partners/maruti-dark.png", width: 200, height: 52, projectName: "Maruti 360" },
  { name: "Ravi Desai Group", logo: "/partners/ravidesai.png", width: 2640, height: 733, overrideClass: "h-11 sm:h-12 max-w-[180px] scale-115" },
  { name: "Satyamev Group", logo: "/partners/satyamev.png", width: 500, height: 129 },
  { name: "Shaligram Group", logo: "/partners/shaligram.png", width: 600, height: 301, projectName: "Shaligram Luxuria" },
  { name: "Sun Builders", logo: "/partners/sun.png", width: 1200, height: 1314 },
  { name: "Swati Procon", logo: "/partners/swati.png", width: 1080, height: 142, projectName: "Swati Senor" },
  { name: "Triveni Group", logo: "/partners/triveni.png", width: 250, height: 139, projectName: "Triveni 84" },
...
export function PartnerMarquee() {
  ...
  return (
    <section className="partner-strip relative overflow-hidden border-y border-[var(--border)] bg-[var(--background)] py-6" aria-label="Developer Alliances">
      {/* Edge gradient masks */}
